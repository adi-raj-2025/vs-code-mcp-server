...
**3. IDENTIFY ALL FILES WITH <100% COVERAGE:**
   - Parse the coverage report to list **ALL** JavaScript files.
...
**6. RE-ANALYZE REPORT:**
   Use #analyze-apigee-report again.
...
6. Re-analyze with #analyze-apigee-report.
...
// New tool for reading custom test data
...
// Tool for custom workflow instructions
...
// New prompt for Custom Test Cases
